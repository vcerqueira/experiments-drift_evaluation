...
class EvaluateDriftDetector:
    ...
    def calc_performance(self,
        ...
        Args:
            ...
            drift_episodes: Optional list of drift episodes. If provided, the trues and preds
    ...
    def _get_drift_episodes(self, trues: ArrayLike, preds: ArrayLike) -> List[Dict[str, Any]]:
        ...
        Returns:
            List of dictionaries representing drift episodes, each containing:
    ...
    def _validate_parameters(max_delay: int, rate_period: int) -> None:
        ...
        Args:
            max_delay: Maximum detection delay to allow.
            rate_period: Period for rate calculations.
    ...
    def _check_arrays(trues: ArrayLike, preds: ArrayLike) -> None:
        ...
        Args:
            trues: Array of drift points (start, end) tuples.
            preds: Array of detection points.
            
        Raises:
            AssertionError: If no drift points are given.
            ValueError: If arrays are unordered or have invalid format.
        """
        if trues is None:
