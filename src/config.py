...
DETECTOR_SYNTH_PARAMS = {
    'ABRUPT': {'ALL': {'ABCD': {'delta_drift': 0.02,
               ...
               'Agrawal': {'ABCD': {'delta_drift': 0.002,
                                    'delta_warn': 0.1,
                                    'encoding_factor': 0.7,
                                    'model_id': 'ae',
                                    'num_splits': 20},
                           'ABCDx': {'delta_drift': 0.002,
                                     'delta_warn': 0.1,
                                     'encoding_factor': 0.7,
                                     'model_id': 'ae',
                                     'num_splits': 20},
    ...
    'GRADUAL': {'ALL': {'ABCD': {'delta_drift': 0.02,
                        ...
                        'EWMAChart': {'lambda_': 0.0001, 'min_n_instances': 5000},
                        'GeometricMovingAverage': {'alpha': 0.8,
                                                   'lambda_': 0.001,
                                                   'min_n_instances': 100},
                        'HDDMAverage': {'drift_confidence': 0.001, 'test_type': 'Two-sided'},
                        'HDDMWeighted': {'drift_confidence': 0.005,
                                         'lambda_': 0.1,
                                         'test_type': 'One-sided'},
                        'PageHinkley': {'alpha': 0.999,
                        ...
                        'SEED': {'alpha': 0.7,
                                 ...
                                 'delta': 0.1,
                                 'epsilon_prime': 0.005},
                        'STEPD': {'alpha_drift': 0.001, 'window_size': 50},
                        'STUDD': {'min_n_instances': 500}},
                'Agrawal': {'ABCD': {'delta_drift': 0.02,
                            ...
                            'GeometricMovingAverage': {'alpha': 0.8,
                                                       'lambda_': 0.001,
                                                       'min_n_instances': 100},
                            'HDDMAverage': {'drift_confidence': 0.001,
                                            'test_type': 'Two-sided'},
                            'HDDMWeighted': {'drift_confidence': 0.005,
                                             'lambda_': 0.1,
                                             'test_type': 'One-sided'},
                ...
                'SEA': {'ABCD': {'delta_drift': 0.02,
                        ...
                        'GeometricMovingAverage': {'alpha': 0.1,
                                                   'lambda_': 0.001,
                                                   'min_n_instances': 30},
                        'HDDMAverage': {'drift_confidence': 0.0001,
                                        'test_type': 'Two-sided'},
                        'HDDMWeighted': {'drift_confidence': 0.01,
                                         'lambda_': 0.1,
                                         'test_type': 'Two-sided'},
                ...
                'STAGGER': {'ABCD': {'delta_drift': 0.02,
                            ...
                            'SEED': {'alpha': 0.7,
                                     ...
                                     'delta': 0.1,
                                     'epsilon_prime': 0.005},
                            'STEPD': {'alpha_drift': 0.002, 'window_size': 500},
                            'STUDD': {'min_n_instances': 500}}}
}
