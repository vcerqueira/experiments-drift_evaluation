...
DETECTOR_ENSEMBLE = ['RDDM', 'ADWIN', 'GeometricMovingAverage', 'STEPD', 'SEED']
...
# OPTIMIZED USING LOO
DETECTOR_SYNTH_PARAMS = {'ALL': {'ABCD': {'delta_drift': 0.01, 'model_id': 'pca'},
                                 'ADWIN': {'delta': 0.01},
                                 'CUSUM': {'delta': 0.01, 'lambda_': 100, 'min_n_instances': 2000},
                                 'DDM': {'min_n_instances': 100, 'out_control_level': 1.75},
                                 'EWMAChart': {'lambda_': 0.001, 'min_n_instances': 50},
                                 'GeometricMovingAverage': {'alpha': 0.99,
                                                            'lambda_': 0.002,
                         ...
                         'Agrawal': {'ABCD': {'delta_drift': 0.01, 'model_id': 'pca'},
                                     'ADWIN': {'delta': 0.01},
                                     'CUSUM': {'delta': 0.01, 'lambda_': 100, 'min_n_instances': 2000},
                                     'DDM': {'min_n_instances': 2000, 'out_control_level': 1.75},
                                     'EWMAChart': {'lambda_': 0.9, 'min_n_instances': 5000},
                                     'GeometricMovingAverage': {'alpha': 0.99,
                                                                'lambda_': 0.002,
                                                                'min_n_instances': 2000},
                                     ...
                                     'PageHinkley': {'alpha': 0.999,
                                                     ...
                                                     'lambda_': 50,
                                                     'min_n_instances': 300},
                                     'RDDM': {'drift_level': 1.75, 'min_n_instances': 2000},
                                     'SEED': {'alpha': 0.2,
                                              'block_size': 100,
                                              'delta': 0.1,
                                              'epsilon_prime': 0.01},
                         ...
                         'SEA': {'ABCD': {'delta_drift': 0.005, 'model_id': 'pca'},
                                 'ADWIN': {'delta': 0.01},
                                 'CUSUM': {'delta': 0.01, 'lambda_': 100, 'min_n_instances': 2000},
                                 'DDM': {'min_n_instances': 2000, 'out_control_level': 2},
                                 'EWMAChart': {'lambda_': 0.001, 'min_n_instances': 50},
                                 'GeometricMovingAverage': {'alpha': 0.99,
                                                            'lambda_': 0.002,
                                                            'min_n_instances': 2000},
                                 'HDDMAverage': {'drift_confidence': 0.01, 'test_type': 'Two-sided'},
                                 'HDDMWeighted': {'drift_confidence': 0.002,
                                                  'lambda_': 0.1,
                                                  'test_type': 'One-sided'},
                                 'PageHinkley': {'alpha': 0.999,
                                                 'delta': 0.001,
                                                 'lambda_': 50,
                                                 'min_n_instances': 300},
                                 'RDDM': {'drift_level': 1.9, 'min_n_instances': 2000},
                                 'SEED': {'alpha': 0.2,
                                          'block_size': 100,
                                          'delta': 0.1,
                                          'epsilon_prime': 0.01},
                                 'STEPD': {'alpha_drift': 0.003, 'window_size': 50},
                                 'STUDD': {'min_n_instances': 1000}},
