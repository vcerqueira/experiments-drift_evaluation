...
class STUDD(BaseDriftDetector):
    ...
    1. Trains a student model on the same data as the teacher.
    2. Monitors the agreement between student and teacher predictions.
    3. Uses a base drift detector (e.g., :class:`ADWIN`) on the agreement signal.
    ...
    def __init__(self,
        ...
        ----------
        student : MOAClassifier
            Student model that mimics the teacher's predictions.
        min_n_instances : int, optional
            Minimum number of instances before monitoring drift.
        detector : MOADriftDetector, optional
            Base drift detector to monitor agreement signal.
        """
        super().__init__()
    ...
    def get_params(self):
        ...
        :returns: Dictionary containing the detector parameters, including
