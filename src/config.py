...
# OPTIMIZED USING LOO
DETECTOR_SYNTH_PARAMS = {
    'ABRUPT': {'ALL': {'ABCD': {'delta_drift': 0.02,
                                'delta_warn': 0.01,
                                'encoding_factor': 0.7,
                                'model_id': 'kpca',
                                'num_splits': 100},
                       'ABCDx': {'delta_drift': 0.02,
                                 'delta_warn': 0.01,
                                 'encoding_factor': 0.7,
                                 'model_id': 'kpca',
                                 'num_splits': 100},
                       'ADWIN': {'delta': 0.01},
                       'CUSUM': {'delta': 0.01, 'lambda_': 50, 'min_n_instances': 2000},
                       'DDM': {'min_n_instances': 2000, 'out_control_level': 2.25},
                       'EWMAChart': {'lambda_': 0.001, 'min_n_instances': 300},
                       'GeometricMovingAverage': {'alpha': 0.5,
                                                  'lambda_': 0.1,
                                                  'min_n_instances': 300},
                       'HDDMAverage': {'drift_confidence': 0.005, 'test_type': 'Two-sided'},
                       'HDDMWeighted': {'drift_confidence': 0.001,
                                        'lambda_': 0.01,
                                        'test_type': 'One-sided'},
                       'PageHinkley': {'alpha': 0.995,
                                       'delta': 0.005,
                                       'lambda_': 30,
                       ...
                       'SEED': {'alpha': 0.6,
                                ...
                                'delta': 0.01,
                                'epsilon_prime': 0.01},
                       'STEPD': {'alpha_drift': 0.001, 'window_size': 500},
                       'STUDD': {'min_n_instances': 5000}},
               'Asfault': {'ABCD': {'delta_drift': 0.02,
                                    'delta_warn': 0.01,
                                    'encoding_factor': 0.7,
                                    'model_id': 'kpca',
                                    'num_splits': 100},
                           ...
                           'GeometricMovingAverage': {'alpha': 0.5,
                                                      'lambda_': 0.1,
                                                      'min_n_instances': 300},
                           'HDDMAverage': {'drift_confidence': 0.005,
                                           'test_type': 'Two-sided'},
                           'HDDMWeighted': {'drift_confidence': 0.001,
                                            'lambda_': 0.01,
                                            'test_type': 'Two-sided'},
                           'PageHinkley': {'alpha': 0.995,
                                           ...
                                           'lambda_': 30,
                                           'min_n_instances': 1000},
                           'RDDM': {'drift_level': 2, 'min_n_instances': 2000},
                           'SEED': {'alpha': 0.5,
                                    'block_size': 32,
                                    'delta': 0.001,
               ...
               'Covtype': {'ABCD': {'delta_drift': 0.02,
                           ...
                           'CUSUM': {'delta': 0.01, 'lambda_': 50, 'min_n_instances': 2000},
                           'DDM': {'min_n_instances': 2000, 'out_control_level': 2.25},
                           'EWMAChart': {'lambda_': 0.002, 'min_n_instances': 1000},
                           'GeometricMovingAverage': {'alpha': 0.5,
                                                      'lambda_': 0.1,
                                                      'min_n_instances': 300},
                           'HDDMAverage': {'drift_confidence': 0.005,
                           ...
                           'STEPD': {'alpha_drift': 0.001, 'window_size': 500},
                           'STUDD': {'min_n_instances': 5000}},
               'Electricity': {'ABCD': {'delta_drift': 0.02,
                                        'delta_warn': 0.1,
                                        'encoding_factor': 0.5,
                                        'model_id': 'ae',
                                        'num_splits': 50},
                               ...
                               'DDM': {'min_n_instances': 500, 'out_control_level': 2},
                               'EWMAChart': {'lambda_': 0.001, 'min_n_instances': 300},
                               'GeometricMovingAverage': {'alpha': 0.5,
                                                          'lambda_': 0.1,
                                                          'min_n_instances': 300},
                               ...
                               'PageHinkley': {'alpha': 0.995,
                                               ...
                                               'lambda_': 30,
                                               'min_n_instances': 1000},
                               'RDDM': {'drift_level': 2.1, 'min_n_instances': 100},
                               'SEED': {'alpha': 0.5,
                                        'block_size': 32,
                                        'delta': 0.001,
                                        'epsilon_prime': 0.0075},
                               'STEPD': {'alpha_drift': 0.001, 'window_size': 100},
                               'STUDD': {'min_n_instances': 5000}},
               'GasSensorArray': {'ABCD': {'delta_drift': 0.02,
                                           'delta_warn': 0.1,
                                           'encoding_factor': 0.5,
                                           'model_id': 'ae',
                                           'num_splits': 50},
                                  ...
                                  'CUSUM': {'delta': 0.01,
                                            'lambda_': 50,
                                            'min_n_instances': 2000},
                                  'DDM': {'min_n_instances': 2000,
                                          'out_control_level': 2.25},
                                  'EWMAChart': {'lambda_': 0.001, 'min_n_instances': 300},
                                  'GeometricMovingAverage': {'alpha': 0.5,
                                                             'lambda_': 0.1,
                                                             'min_n_instances': 300},
               ...
               'NOAA': {'ABCD': {'delta_drift': 0.02,
                        ...
                        'STEPD': {'alpha_drift': 0.001, 'window_size': 500},
                        'STUDD': {'min_n_instances': 5000}},
               'Posture': {'ABCD': {'delta_drift': 0.02,
                                    'delta_warn': 0.01,
                                    'encoding_factor': 0.7,
                                    'model_id': 'kpca',
                                    'num_splits': 100},
                           'ABCDx': {'delta_drift': 0.001,
                                     'delta_warn': 0.1,
                                     'encoding_factor': 0.5,
                                     'model_id': 'kpca',
                                     'num_splits': 50},
                           ...
                           'CUSUM': {'delta': 0.01, 'lambda_': 50, 'min_n_instances': 2000},
                           'DDM': {'min_n_instances': 500, 'out_control_level': 2},
                           'EWMAChart': {'lambda_': 0.002, 'min_n_instances': 500},
                           'GeometricMovingAverage': {'alpha': 0.5,
                                                      'lambda_': 0.1,
                                                      'min_n_instances': 300},
                           'HDDMAverage': {'drift_confidence': 0.005,
    ...
    ,
    'GRADUAL': {'ALL': {'ABCD': {'delta_drift': 0.02,
                                 'delta_warn': 0.01,
                                 'encoding_factor': 0.7,
                                 'model_id': 'kpca',
                                 'num_splits': 100},
                        'ABCDx': {'delta_drift': 0.0001,
                                  'delta_warn': 0.01,
                                  'encoding_factor': 0.3,
                                  'model_id': 'kpca',
                                  'num_splits': 20},
                        'ADWIN': {'delta': 0.01},
                        'CUSUM': {'delta': 0.001, 'lambda_': 100, 'min_n_instances': 30},
                        'DDM': {'min_n_instances': 100, 'out_control_level': 1.75},
                        'EWMAChart': {'lambda_': 0.002, 'min_n_instances': 500},
                        'GeometricMovingAverage': {'alpha': 0.1,
                                                   'lambda_': 0.1,
                                                   'min_n_instances': 100},
                        'HDDMAverage': {'drift_confidence': 0.002, 'test_type': 'Two-sided'},
                ...
                'GasSensorArray': {'ABCD': {'delta_drift': 0.02,
                                   ...
                                   'CUSUM': {'delta': 0.001,
                                             'lambda_': 100,
                                             'min_n_instances': 30},
                                   'DDM': {'min_n_instances': 100,
                                           'out_control_level': 1.75},
                                   'EWMAChart': {'lambda_': 0.0001, 'min_n_instances': 100},
                                   'GeometricMovingAverage': {'alpha': 0.1,
                                                              'lambda_': 0.1,
                                                              'min_n_instances': 100},
                ...
                'NOAA': {'ABCD': {'delta_drift': 0.02,
                         ...
                         'ABCDx': {'delta_drift': 0.0001,
                                   ...
                                   'num_splits': 20},
                         'ADWIN': {'delta': 0.01},
                         'CUSUM': {'delta': 0.002, 'lambda_': 100, 'min_n_instances': 500},
                         'DDM': {'min_n_instances': 100, 'out_control_level': 1.75},
                         'EWMAChart': {'lambda_': 0.002, 'min_n_instances': 500},
                         'GeometricMovingAverage': {'alpha': 0.1,
                                                    'lambda_': 0.1,
                ...
                'Posture': {'ABCD': {'delta_drift': 0.02,
                            ...
                            'CUSUM': {'delta': 0.001, 'lambda_': 100, 'min_n_instances': 30},
                            'DDM': {'min_n_instances': 2000, 'out_control_level': 2.25},
                            'EWMAChart': {'lambda_': 0.005, 'min_n_instances': 2000},
                            'GeometricMovingAverage': {'alpha': 0.1,
                                                       'lambda_': 0.1,
                                                       'min_n_instances': 100},
                            'HDDMAverage': {'drift_confidence': 0.002,
